...
const Fonts = () => (
    <div>
        ...
        <table className={ nb("w100 mb2 ft4 tcg60 lh2 sans") }>
            <thead>
                <tr className={ nb("brdr1--bottom bcg10 bgg05") }>
                    <th className={ nb("pa1 tal fwsemibold") }>Style</th>
                    <th className={ nb("pa1 tal fwsemibold") }>Class</th>
                    <th className={ nb("pa1 tal fwsemibold") }>Default Stack</th>
                </tr>
            </thead>
            <tbody>
                <tr className={ nb("brdr1--bottom bcg10") }>
                    <td className={ nb("tcg50 fw3 pv2 ph1") }>Sans Serif</td>
                    <td className={ nb("tcg50 fw3 pv2 ph1") }><Code>.sans</Code></td>
                    <td className={ nb("tcg50 fw3 pv2 ph1") }><Code>'Helvetica Neue', Helvetica, Arial, sans-serif</Code></td>
                </tr>
                <tr className={ nb("brdr1--bottom bcg10") }>
                    <td className={ nb("tcg50 fw3 pv2 ph1") }>Serif</td>
                    <td className={ nb("tcg50 fw3 pv2 ph1") }><Code>.serif</Code></td>
                    <td className={ nb("tcg50 fw3 pv2 ph1") }><Code>Merriweather, Georgia, serif</Code></td>
                </tr>
                <tr className={ nb("brdr1--bottom bcg10") }>
        ...
        <table className={ nb("w100 mb2 ft4 tcg60 lh2 sans") }>
            ...
            <tbody>
                <tr className={ nb("brdr1--bottom bcg10") }>
                    <td className={ nb("tcg50 fw3 pv2 ph1") }>Thin</td>
                    <td className={ nb("tcg50 fw3 pv2 ph1") }><Code>100</Code></td>
                    <td className={ nb("tcg50 fw3 pv2 ph1") }><Code>.fw1</Code> or <Code>.fwthin</Code></td>
                </tr>
                <tr className={ nb("brdr1--bottom bcg10") }>
                    <td className={ nb("tcg50 fw3 pv2 ph1") }>Extra Light</td>
                    <td className={ nb("tcg50 fw3 pv2 ph1") }><Code>200</Code></td>
                    <td className={ nb("tcg50 fw3 pv2 ph1") }><Code>.fw2</Code> or <Code>.fwxlight</Code></td>
                </tr>
                <tr className={ nb("brdr1--bottom bcg10") }>
                    <td className={ nb("tcg50 fw3 pv2 ph1") }>Light</td>
                    <td className={ nb("tcg50 fw3 pv2 ph1") }><Code>300</Code></td>
                    <td className={ nb("tcg50 fw3 pv2 ph1") }><Code>.fw3</Code> or <Code>.fwlight</Code></td>
                </tr>
                <tr className={ nb("brdr1--bottom bcg10") }>
                    <td className={ nb("tcg50 fw3 pv2 ph1") }>Normal</td>
                    <td className={ nb("tcg50 fw3 pv2 ph1") }><Code>400</Code></td>
                    <td className={ nb("tcg50 fw3 pv2 ph1") }><Code>.fw4</Code> or <Code>.fwnormal</Code></td>
                </tr>
                <tr className={ nb("brdr1--bottom bcg10") }>
                    <td className={ nb("tcg50 fw3 pv2 ph1") }>Medium</td>
                    <td className={ nb("tcg50 fw3 pv2 ph1") }><Code>500</Code></td>
                    <td className={ nb("tcg50 fw3 pv2 ph1") }><Code>.fw5</Code> or <Code>.fwmedium</Code></td>
                </tr>
                <tr className={ nb("brdr1--bottom bcg10") }>
                    <td className={ nb("tcg50 fw3 pv2 ph1") }>Semibold</td>
                    <td className={ nb("tcg50 fw3 pv2 ph1") }><Code>600</Code></td>
                    <td className={ nb("tcg50 fw3 pv2 ph1") }><Code>.fw6</Code> or <Code>.fwsemibold</Code></td>
                </tr>
                <tr className={ nb("brdr1--bottom bcg10") }>
                    <td className={ nb("tcg50 fw3 pv2 ph1") }>Bold</td>
                    <td className={ nb("tcg50 fw3 pv2 ph1") }><Code>700</Code></td>
                    <td className={ nb("tcg50 fw3 pv2 ph1") }><Code>.fw7</Code> or <Code>.fwbold</Code></td>
                </tr>
                <tr className={ nb("brdr1--bottom bcg10") }>
                    <td className={ nb("tcg50 fw3 pv2 ph1") }>Extra Bold</td>
                    <td className={ nb("tcg50 fw3 pv2 ph1") }><Code>800</Code></td>
                    <td className={ nb("tcg50 fw3 pv2 ph1") }><Code>.fw8</Code> or <Code>.fwxbold</Code></td>
                </tr>
                <tr className={ nb("brdr1--bottom bcg10") }>
                    <td className={ nb("tcg50 fw3 pv2 ph1") }>Black</td>
                    <td className={ nb("tcg50 fw3 pv2 ph1") }><Code>900</Code></td>
                    <td className={ nb("tcg50 fw3 pv2 ph1") }><Code>.fw9</Code> or <Code>.fwblack</Code></td>
                </tr>
            </tbody>
        </table>
        ...
        <table className={ nb("w100 mb2 ft4 tcg60 lh2 sans") }>
            ...
            <tbody>
                ...
                <tr className={ nb("brdr1--bottom bcg10") }>
                    ...
                    <td className={ nb("vam pv1 ft11") }>Hi</td>
                </tr>
                <tr className={ nb("brdr1--bottom bcg10") }>
