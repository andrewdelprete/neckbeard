        ...
        <table className={ nb("w100 mb2 ft4 tcg60 lh2 sans") }>
            ...
            <tbody>
                <tr className={ nb("brdr1--bottom bcg10") }>
                    ...
                    <td className={ nb("tcg50 fw3 pv1 ph1") }><code>.zi1</code></td>
                </tr>
                <tr className={ nb("brdr1--bottom bcg10") }>
                    <td className={ nb("tcg50 fw3 pv1 ph1") }>Level 2</td>
                    <td className={ nb("tcg50 fw3 pv1 ph1") }><code>.zi2</code></td>
                </tr>
                <tr className={ nb("brdr1--bottom bcg10") }>
                    <td className={ nb("tcg50 fw3 pv1 ph1") }>Level 3</td>
                    <td className={ nb("tcg50 fw3 pv1 ph1") }><code>.zi3</code></td>
                </tr>
                <tr className={ nb("brdr1--bottom bcg10") }>
                    <td className={ nb("tcg50 fw3 pv1 ph1") }>Level 4</td>
                    <td className={ nb("tcg50 fw3 pv1 ph1") }><code>.zi4</code></td>
                </tr>
                <tr className={ nb("brdr1--bottom bcg10") }>
                    <td className={ nb("tcg50 fw3 pv1 ph1") }>Level 5</td>
                    <td className={ nb("tcg50 fw3 pv1 ph1") }><code>.zi5</code></td>
                </tr>
                <tr className={ nb("brdr1--bottom bcg10") }>
                    <td className={ nb("tcg50 fw3 pv1 ph1") }>Level 6</td>
                    <td className={ nb("tcg50 fw3 pv1 ph1") }><code>.zi6</code></td>
                </tr>
                <tr className={ nb("brdr1--bottom bcg10") }>
                    <td className={ nb("tcg50 fw3 pv1 ph1") }>Level 7</td>
                    <td className={ nb("tcg50 fw3 pv1 ph1") }><code>.zi7</code></td>
                </tr>
                <tr className={ nb("brdr1--bottom bcg10") }>
                    <td className={ nb("tcg50 fw3 pv1 ph1") }>Level 8</td>
                    <td className={ nb("tcg50 fw3 pv1 ph1") }><code>.zi8</code></td>
                </tr>
                <tr className={ nb("brdr1--bottom bcg10") }>
                    <td className={ nb("tcg50 fw3 pv1 ph1") }>Level 9</td>
                    <td className={ nb("tcg50 fw3 pv1 ph1") }><code>.zi9</code></td>
                </tr>
                <tr className={ nb("brdr1--bottom bcg10") }>
                    <td className={ nb("tcg50 fw3 pv1 ph1") }>Level 10</td>
                    <td className={ nb("tcg50 fw3 pv1 ph1") }><code>.zi10</code></td>
                </tr>
            </tbody>
        </table>
