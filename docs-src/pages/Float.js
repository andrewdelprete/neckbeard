        ...
        <table className={ nb("w100 mb2 ft4 tcg60 lh2 sans") }>
            ...
            <tbody>
                <tr className={ nb("brdr1--bottom bcg10") }>
                    <td className={ nb("tcg50 fw3 pv1 ph1") }><Code>.fl</Code></td>
                    <td className={ nb("tcg50 fw3 pv1 ph1") }><Code>float: left</Code></td>
                </tr>
                <tr className={ nb("brdr1--bottom bcg10") }>
                    <td className={ nb("tcg50 fw3 pv1 ph1") }><Code>.fr</Code></td>
                    <td className={ nb("tcg50 fw3 pv1 ph1") }><Code>float: right</Code></td>
                </tr>
                <tr className={ nb("brdr1--bottom bcg10") }>
                    <td className={ nb("tcg50 fw3 pv1 ph1") }><Code>.fn</Code></td>
                    <td className={ nb("tcg50 fw3 pv1 ph1") }><Code>float: none</Code></td>
                </tr>
                <tr className={ nb("brdr1--bottom bcg10") }>
                    <td className={ nb("tcg50 fw3 pv1 ph1") }><Code>.finit</Code></td>
                    <td className={ nb("tcg50 fw3 pv1 ph1") }><Code>float: initial</Code></td>
                </tr>
                <tr className={ nb("brdr1--bottom bcg10") }>
                    <td className={ nb("tcg50 fw3 pv1 ph1") }><Code>.finhe</Code></td>
                    <td className={ nb("tcg50 fw3 pv1 ph1") }><Code>float: inherit</Code></td>
                </tr>
            </tbody>
        </table>
        <H2>Example</H2>
